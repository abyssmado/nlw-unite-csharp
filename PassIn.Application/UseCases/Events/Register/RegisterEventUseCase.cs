...
public class RegisterEventUseCase
{
    ...
    public void Validate(RequestEventJson request)
    {
        ...
        if (string.IsNullOrWhiteSpace(request.Title)) throw new ErrorOnValidationException("The title is invalid.");

        if (string.IsNullOrWhiteSpace(request.Details)) throw new ErrorOnValidationException("The title is invalid.");
    }
}